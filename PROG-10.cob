      ...
      *                                             
        ...
        77  WK-TOT-AGENCIA                 PIC 9(08)V99   VALUE ZEROS.   
        77  WK-CONT-LINHA                  PIC 9          VALUE ZEROS.   
      *                                                                 
        PROCEDURE DIVISION.                                              
      ...
      *******************************************************      
        ...
        202-IMPRIME-CLIENTES.                                       
            IF FD-AGENCIA-CLIENTES NOT EQUAL WK-AG-CORRENTE         
                PERFORM 203-TOTALIZA                                
            END-IF.                                                 
            IF WK-CONT-LINHA EQUAL 0 OR WK-CONT-LINHA >= 5          
        ...
        203-TOTALIZA.                                         
           ...
           MOVE 0 TO WK-TOT-AGENCIA WK-CONT-LINHA.           
           MOVE FD-AGENCIA-CLIENTES TO WK-AG-CORRENTE.       
       204-CABECALHO.                                        
           ADD 1 TO WK-NUMPAG.                               
           ...
           WRITE REG-RELATO FROM WK-CABEC1 AFTER 2 LINES.    
           MOVE 0 TO WK-CONT-LINHA.                          
       205-IMPRIME.                                          
